...
function Compromiso() {
  ...
  const renderBotonFinal = () => {
    if (destino === 'trabajadora') {
      return (
        <button
        ...
        >
          Acepto y continuar al registro profesional
        </button>
      )
    }
    ...
    if (destino === 'clienta') {
      return (
        ...
        >
          Acepto y continuar al registro de clienta
        </button>
      )
    }
  ...
  const textoDestino =
    destino === 'trabajadora'
      ? 'Antes de crear tu perfil profesional, debes leer y aceptar este compromiso obligatorio.'
      : destino === 'clienta'
      ? 'Antes de registrarte como usuaria, debes leer y aceptar este compromiso obligatorio.'
      : 'Antes de continuar en Hana, debes leer y aceptar este compromiso obligatorio.'
    ...
    >
      ...
      <div style={{ maxWidth: '880px', margin: '0 auto', padding: '56px 24px' }}>
        ...
        >
          ...
          >
            🛡️ Verificación de identidad obligatoria
          </h2>
        ...
        >
          ...
          >
            👑 Presencia obligatoria durante el servicio
          </h2>
        ...
        >
          ...
          >
            🚫 La trabajadora acude sola al servicio
          </h2>
        ...
        >
          ...
          >
            Al hacer clic en “Acepto y continuar”, quedará registrado en nuestra base de datos tu consentimiento junto con la fecha y hora exacta. Este registro forma parte del proceso obligatorio para usar Hana.
          </p>
        </div>
        ...
        >
          ...
          >
            Solo después de leer este documento completo debes presionar el botón de aceptación para continuar.
          </p>
        </div>
