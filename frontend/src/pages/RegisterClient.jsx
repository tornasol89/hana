...
function RegisterClient() {
  ...
  const [form, setForm] = useState({
    ...
    password: '', confirmar: '', rut: '', region: '', comuna: ''
  })
  ...
  return (
    <div style={{ backgroundColor: '#1a0a10', minHeight: '100vh', color: 'white', fontFamily: 'sans-serif', display: 'flex', flexDirection: 'column' }}>
      ...
      {/* CONTENIDO */}
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 24px', background: 'radial-gradient(ellipse at 70% 50%, rgba(212,83,126,0.2) 0%, transparent 60%), #1a0a10' }}>
        <div style={{ background: '#2d0a1e', border: '1px solid #d4537e', borderRadius: '20px', padding: '40px', width: '100%', maxWidth: '480px' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '28px' }}>
            ...
            <h1 style={{ fontSize: '24px', fontWeight: '800', color: '#ffffff', margin: '0 0 6px' }}>Crea tu cuenta</h1>
            <p style={{ fontSize: '14px', color: '#cccccc', margin: 0 }}>Encuentra a la profesional que necesitas</p>
          </div>
          ...
          <div style={{ display: 'flex', gap: '10px', marginBottom: '24px' }}>
            ...
            <Link to="/register-worker" style={{ flex: 1, textAlign: 'center', padding: '10px', backgroundColor: 'transparent', border: '2px solid rgba(212,83,126,0.4)', borderRadius: '10px', textDecoration: 'none' }}>
